      ...
      <button
        ...
        className={cn(
          ...
          matches("muted", variant) && {
            "hover:theme:bg-primary-light/15 theme:bg-primary-light/10 theme:text-primary-light":
              matches("primary", background),
            "hover:theme:bg-secondary-light/15 theme:bg-secondary-light/10 theme:text-secondary-dark":
              matches("secondary", background),
            "hover:theme:bg-accent-light/15 theme:bg-accent-light/10 theme:text-accent-light":
              matches("accent", background),
